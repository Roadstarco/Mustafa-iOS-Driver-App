...
//  Family Pic Will
//
//  Created by Shami Mac on 10/09/2021.
//
...
@objc open class RPicker: NSObject {
    ...
    */
    ...
    private class func controller(title: String? = nil,
                          ...
                          style: RDatePickerStyle = .Inline) -> RPickerController? {
...
class RPickerController: UIViewController {
    ...
    var datePickerStyle: RDatePickerStyle = .Inline //Only for iOS 14 and above
